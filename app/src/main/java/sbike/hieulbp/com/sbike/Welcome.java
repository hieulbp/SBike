...
import sbike.hieulbp.com.sbike.Common.Common;
...

{
    ...
    private LatLng startPostion, endPostion, currentPosition;
...
//    private Button btnGo;
        ...
        public void run() {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition.Builder().target(newPos)
                                                                            .zoom(15.5f).build()));
                }
            });
            valueAnimator.start();
    ...
    private void getDirection() {
        ...
        try{
            ...
            Log.d("hieulbp",requestApi);
            mService.getPath(requestApi)
                    .enqueue(new Callback<String>() {
                        @Override
                        public void onResponse(Call<String> call, Response<String> response) {
                            Log.d("Bug", response.body().toString() );
                            try {
            ...
            if(location_switch.isChecked()){
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        //add marker
                        if(mCurrent!=null)
                            mCurrent.remove(); //remove already merker
